...
titles <- c("Cumulative cases (PCR+)", "Daily cases (PCR+)", "Cases (Ab+)",
            ...
            "CI14", "CI7", "Percentage Increment", "Rt",
            "Cumulative hospitalized", "Daily hospitalized", "Punctual hospitalized",
            "Cumulative ICU", "Daily ICU", "Punctual ICU",
            "Daily discharged", "Hospitals occupancy (%)", "ICU occupancy (%)",
            "Incidence rate", "Mobility (%)", "Population", "Seroprevalence-1 (%)", "Seroprevalence-2 (%)", "Seroprevalence-3 (%)",
            "Fully vaccinated people", "Fully vaccinated rate (%)", "Vaccines administered",
...
names(titles) <- c("PCR", "newPCR", "TestAC",
                   ...
                   "CI14", "CI7", "PorcentualIncrementCasesTotal", "Rt",
                   "Hospitalized", "newHospitalized", "PunctualHospitalized",
                   "UCI", "newUCI","PunctualUCI",
                   "newDischarged", "PercentagedBed", "PercentagedBedUCI",
                   "RateCasesCum", "mobility", "Population",
                   "ENE_round1", "ENE_round2", "ENE_round3",
                   "CompletedVaccinated", "PercentagedCompletedVaccinated", "DoseAdministered",
...
choicesVariables <- list(
  "COVID-19 Metrics" = list("Cumulative cases (Total)" = "CasesTotal",
                            ...
                            "Cumulative ICU" = "UCI",
                            "Daily ICU" = "newUCI",
                            "Punctual ICU" = "PunctualUCI",
                            "Daily discharged" = "newDischarged",
                            "Hospitals occupancy" = "PercentagedBed",
                            "ICU occupancy" = "PercentagedBedUCI",
                            "Seroprevalence-1" = "ENE_round1",
                            "Seroprevalence-2" = "ENE_round2",
                            "Seroprevalence-3" = "ENE_round3",
                            "Fully vaccinated people" = "CompletedVaccinated",
                            "Fully vaccinated rate" = "PercentagedCompletedVaccinated",
                            "Vaccines administered" = "DoseAdministered"),
  "Calculations" = list("Rt" = "Rt",
                        "Incidence rate" = "RateCasesCum",
